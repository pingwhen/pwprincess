...
<html>
	<head>
		...
		<meta name="google-site-verification" content="cZOJGoFE5C00sdIdsaAQRQL30Y1EDX4TzUcQlvTSGZo" />
        ...
        <meta name="msapplication-TileColor" content="#d51065">
	...
	<header id="header">
		<div class="container">
			<div class="logo">
				<a href="/">
					<img alt="Porto" width="180" height="55" src="img/logo.png">
				</a>
			</div>
		...
		<div class="navbar-collapse nav-main-collapse collapse">
			<div class="container">
				<ul class="social-icons">
					...
					<li class="linkedin"><a href="https://www.linkedin.com/company/pingwhen/" target="_blank" title="Linkedin">Linkedin</a></li>
				</ul>
				<nav class="nav-main mega-menu">
					<ul class="nav nav-pills nav-main" id="mainMenu">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a class="page-scroll" href="#footer">Beta Tester<span class="tip">Exclusive</span></a></li>
